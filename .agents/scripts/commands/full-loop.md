...
**4.2 PR Create** — rebase onto `origin/main`, push, create PR. Body MUST include `Closes #NNN` (MANDATORY). Append signature footer via `gh-signature-helper.sh`. Add `origin:worker` or `origin:interactive` label.
