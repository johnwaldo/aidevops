...
Every session should improve the system, not just complete its task. Full guidance: `aidevops/self-improving-agents.md`.
...
| Framework | `aidevops/architecture.md`, `aidevops/self-improving-agents.md`, `scripts/commands/skills.md` |
