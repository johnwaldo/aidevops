...
Preview URLs include auto-generated tokens (e.g., `https://8080-sandbox-abc123def456.yourdomain.com`). Token changes on each expose operation, reducing unauthorized access risk.
